...
import 'package:project/page/My_page.dart';
import 'package:project/page/cart_page.dart';
import 'package:project/page/home_page.dart';
import 'package:project/page/search_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        BottomNavigationBarItem(icon: Icon(Icons.shopping_bag,color: _defaultColor),
